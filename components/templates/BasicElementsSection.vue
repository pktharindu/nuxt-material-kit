      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-25 md-xsmall-size-100 md-small-size-50 md-medium-size-25">
          ...
          <div class="flex-column">
            ...
            <md-checkbox
              v-model="checkbox3"
              disabled>Disabled Checked</md-checkbox>
            <md-checkbox
              v-model="checkbox4"
              disabled>Disabled Unchecked</md-checkbox>
          </div>
        </div>
        <div class="md-layout-item md-size-25 md-xsmall-size-100 md-small-size-50 md-medium-size-25">
          <div class="title">
          ...
          <div class="flex-column">
            <md-radio
              v-model="radio1"
              :value="true">Radio is on</md-radio>
            <md-radio
              v-model="radio1"
              :value="false">Radio is off</md-radio>
            <md-radio
              v-model="radio2"
              :value="true"
              disabled>Disabled Radio is on</md-radio>
            <md-radio
              v-model="radio2"
              :value="false"
              disabled>Disabled Radio is off</md-radio>
          </div>
        </div>
        <div class="md-layout-item md-size-25 md-xsmall-size-100 md-small-size-50 md-medium-size-25">
          <div class="title">
