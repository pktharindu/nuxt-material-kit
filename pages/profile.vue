              ...
              <div class="profile">
                ...
                <div class="name">
                  ...
                  <md-button
                    ...
                    class="md-just-icon md-simple md-dribbble"><i class="fab fa-dribbble"/></md-button>
                  <md-button
                    href="javascript:void(0)"
                    class="md-just-icon md-simple md-twitter"><i class="fab fa-twitter"/></md-button>
                  <md-button
                    href="javascript:void(0)"
                    class="md-just-icon md-simple md-pinterest"><i class="fab fa-pinterest"/></md-button>
                </div>
              </div>
            </div>
          </div>
